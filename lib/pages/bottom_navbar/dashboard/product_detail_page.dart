            ...
            children: [
              ...
              pw.Table(
                ...
                children: [
                  ...
                  tableRow('Status', _safeToString(ticket.orderStatus == 1 ? 'Paid' : 'Purchased')),
                  tableRow('Prize', _safeToString(ticket.raffleDrawPrize)),
                  tableRow('Numbers', _safeToString(ticket.numbers)),
                  tableRow('Straight', _safeToString(ticket.straight == 1 ? 'Yes' : 'No')),
                  tableRow('Rumble', _safeToString(ticket.rumble == 1 ? 'Yes' : 'No')),
                  tableRow('Chance', _safeToString(ticket.chance == 1 ? 'Yes' : 'No')),
                  tableRow('Is Announced', _safeToString(ticket.isAnnounced == true ? "Announced" : "Not Announced")),
                ],
              ),
              pw.SizedBox(height: 30),
              pw.Container(
