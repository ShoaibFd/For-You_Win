...
class _ForYouPageState extends State<ForYouPage> with TickerProviderStateMixin {
  ...
  Future<void> handlePrint(Map<String, dynamic> matchedTicket) async {
    ...
    try {
      ...
      final file = File('${tempDir.path}/foryou${matchedTicket['ticket_id']}.pdf');
      ...
      if (mounted) {
        AppSnackbar.showSuccessSnackbar('ForYou ticket receipt printed successfully!');
      }
    } catch (e) {
        ...
        build: (context) {
          return [
            ...
            pw.Container(
              ...
              child: pw.Center(
                child: pw.Text(
                  '4uwin-5 Winning Ticket Receipt',
              ...
              builder: (context, ticket, child) {
                return Column(
                  ...
                  children: [
                    ...
                    if (!ticket.isLoading && ticket.foryouTicketData == null) SizedBox(),
                  ],
                );
              },
            ),
