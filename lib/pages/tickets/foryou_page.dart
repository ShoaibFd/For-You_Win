...
class ForYouPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: AppDrawer(),
      appBar: AppBar(title: AppText('ForYou Game', fontSize: 16.sp, fontWeight: FontWeight.w600)),
      body: Padding(
          ...
          builder: (context, ticket, child) {
            return Column(
              ...
              children: [
                ...
                Center(child: AppText('ForYou Ticket Search', fontSize: 20.sp, fontWeight: FontWeight.bold)),
                ...
                // Display API data
                if (ticket.foryouTicketData != null && !ticket.isLoading)
                  Expanded(
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 20.h),
                          dataRow('Status', ticket.foryouTicketData!['status'].toString(), valueColor: Colors.green),
                          Divider(),
                          dataRow('Order Number', ticket.foryouTicketData!['order_number'].toString()),
                          Divider(),
                          dataRow('Draw Date', ticket.foryouTicketData!['draw_date'].toString()),
                          Divider(),
                          dataRow('Has Winners', ticket.foryouTicketData!['has_winners'].toString()),
                          Divider(),
                          dataRow('Total Prize Sum', ticket.foryouTicketData!['total_prize_sum'].toString()),
                          ...
                          Row(
                            children:
                                (ticket.foryouTicketData!['winning_numbers'] as List<dynamic>?)
                                    ?.map<Widget>(
                                      (number) => CircleAvatar(
                          ...
                          ...ticket.foryouTicketData!['tickets']?.map<Widget>((ticketData) {
                                  ...
                                  children: [
                                    ...
                                    if (isWinner && ticketData['order_status'] != 1)
                                      PrimaryButton(
                                        ...
                                        onTap: () {
                                          ticket.payTicket(
                                            ticket.foryouTicketData!['order_number'],
                ...
                if (!ticket.isLoading && ticket.foryouTicketData == null)
