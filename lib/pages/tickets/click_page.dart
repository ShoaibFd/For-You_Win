...
class ClickPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: AppDrawer(),
      appBar: AppBar(title: AppText('Click-2 Game', fontSize: 16.sp, fontWeight: FontWeight.w600)),
      body: Padding(
          ...
          builder: (context, ticket, child) {
            return Column(
              ...
              children: [
                ...
                Center(child: AppText('Click-2 Ticket Search', fontSize: 20.sp, fontWeight: FontWeight.bold)),
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 20.h),
                          dataRow('Status', ticket.clickTicketData!['status'].toString(), valueColor: Colors.green),
                          Divider(),
                                ...
                                return Column(
                                  ...
                                  children: [
                                    ...
                                    PrimaryButton(
                                      ...
                                      onTap: () {
                                        ticket.payTicket(
                                          ticket.clickTicketData!['order_number'],
                ...
                if (!ticket.isLoading && ticket.clickTicketData == null)
