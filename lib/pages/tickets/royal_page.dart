...
class _RoyalPageState extends State<RoyalPage> with TickerProviderStateMixin {
  ...
  Future<void> handlePayment(TicketServices ticket, Map<String, dynamic> matchedTicket) async {
    ...
    invoiceData = {
      ...
      'orderNumber': ticket.royalTicketData!['order_number'],
  ...
  Future<void> handlePrint(Map<String, dynamic> matchedTicket) async {
    ...
    try {
      ...
      final file = File('${tempDir.path}/royal_ticket_${matchedTicket['ticket_id']}.pdf');
      ...
      if (mounted) {
        AppSnackbar.showSuccessSnackbar('Royal ticket receipt printed successfully!');
      }
    } catch (e) {
        ...
        build: (context) {
          return [
            ...
            pw.Container(
              ...
              child: pw.Center(
                child: pw.Text(
                  'Royal-6 Winning Ticket Receipt',
            ...
            pw.Container(
              ...
              child: pw.Column(
                children: [
                  ...
                  buildNumbersGrid(matchedTicket['numbers'] ?? []),
                ],
              ),
            ),
            ...
            pw.Container(
              ...
              child: pw.Column(
                children: [
                  ...
                  pw.SizedBox(height: 8),
                  buildNumbersGrid(matchedTicket['matched_numbers'] ?? []),
                ],
              ),
            ),
            pw.SizedBox(height: 20),
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Wrap(
                                                ...
                                                runSpacing: 8.h,
                                                children:
                                                    (invoiceData!['ticket']['numbers'] as List).map((number) {
                                                      return Container(
                                                        width: 35.w,
                                                        height: 35.h,
                                                        decoration: BoxDecoration(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Wrap(
                                                ...
                                                runSpacing: 8.h,
                                                children:
                                                    (invoiceData!['ticket']['matched_numbers'] as List).map((number) {
                                                      return Container(
                                                        width: 35.w,
                                                        height: 35.h,
                                                        decoration: BoxDecoration(
