...
class ThrillPage extends StatelessWidget {
  ThrillPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: AppDrawer(),
      appBar: AppBar(title: AppText('Thrill-3 Game', fontSize: 16.sp, fontWeight: FontWeight.w600)),
      body: Padding(
          ...
          builder: (context, ticket, child) {
            return Column(
              ...
              children: [
                ...
                Center(child: AppText('Thrill Ticket Search', fontSize: 20.sp, fontWeight: FontWeight.bold)),
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 20.h),
                          dataRow('Status', ticket.thrillTicketData!['status'].toString(), valueColor: Colors.green),
                          Divider(),
                          ...
                          ...ticket.thrillTicketData!['tickets']?.map<Widget>((matched) {
                                final rows = [
                                  ...
                                  MapEntry('Numbers', matched['numbers']),
                                  MapEntry('Matched', matched['matched_numbers']),
                                ...
                                return Column(
                                  ...
                                  children: [
                                    ...
                                    PrimaryButton(
                                      ...
                                      onTap: () {
                                        ticket.payTicket(
                                          ticket.thrillTicketData!['order_number'],
                ...
                if (!ticket.isLoading && ticket.thrillTicketData == null)
