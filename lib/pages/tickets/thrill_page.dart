...
class _ThrillPageState extends State<ThrillPage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _clearThrillData(); // Clear data on init for fresh state
  ...
  void _clearThrillData() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        ...
        ticket.clearThrillTicketData();
        log('🧹 Cleared ThrillPage data and TicketServices thrillTicketData');
      }
    });
  }
  ...
  void _performSearch(String orderNumber) {
    ...
    try {
      final ticket = Provider.of<TicketServices>(context, listen: false);
      ticket.thrillTicketSearch(orderNumber.trim());
      log('🔍 Searching for Thrill-3 order number: $orderNumber');
  ...
  Future<void> handleBulkPayment(TicketServices ticket, List<Map<String, dynamic>> winningTickets) async {
    ...
    final orderNumber = ticket.thrillTicketData?['order_number']?.toString();
    if (orderNumber == null) {
  ...
  List<Map<String, dynamic>> _findWinningTickets(TicketServices ticket) {
    if (ticket.thrillTicketData == null || ticket.thrillTicketData!['tickets'] == null) return [];

    final tickets = ticket.thrillTicketData!['tickets'] as List<dynamic>;
  ...
  @override
  void dispose() {
    _clearThrillData(); // Clear data when leaving
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        _clearThrillData(); // Clear data on back navigation
        return true;
      },
      child: Scaffold(
        drawer: AppDrawer(),
                ...
                builder: (context, ticket, child) {
                  ...
                  return Column(
                    ...
                    children: [
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              _buildDetailRow(
                                                'Order Number:',
                                                ticket.thrillTicketData!['order_number'].toString(),
                                              ),
                                              _buildDetailRow(
                                                'Order Date:',
                      ...
                      if (ticket.thrillTicketData != null && winningTickets.isEmpty && !ticket.isLoading)
                        Expanded(
                          child: Center(
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: AppText(
                                            '🎉 Thrill-3 Winner${invoiceData!['ticketCount'] > 1 ? 's' : ''}! 🎉',
                                            fontSize: 18.sp,
                                            fontWeight: FontWeight.bold,
                                            textAlign: TextAlign.center,
                                            color: Colors.green[800],
